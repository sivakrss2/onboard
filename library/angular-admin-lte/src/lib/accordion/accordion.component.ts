...
export class AccordionComponent implements OnInit {
  ...
  @ContentChild(AccordionHeaderComponent, /* TODO: add static flag */ {static: true }) public accordionHeaderComponent: AccordionHeaderComponent;
  @ContentChild(AccordionContentComponent, /* TODO: add static flag */ {static: true }) public accordionContentComponent: AccordionContentComponent;
