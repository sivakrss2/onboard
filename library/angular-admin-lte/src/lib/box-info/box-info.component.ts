...
export class BoxInfoComponent implements OnInit {
  ...
  @ContentChild(BoxInfoHeaderDirective, /* TODO: add static flag */ {static: true }) public boxInfoHeaderDirective: BoxInfoHeaderDirective;
  @ContentChild(BoxInfoFooterDirective, /* TODO: add static flag */ {static: true }) public boxInfoFooterDirective: BoxInfoFooterDirective;
  @ContentChild(BoxInfoContentDirective, /* TODO: add static flag */ {static: true }) public boxInfoContentDirective: BoxInfoContentDirective;
