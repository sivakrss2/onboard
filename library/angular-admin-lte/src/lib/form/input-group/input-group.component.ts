...
export class InputGroupComponent implements AfterContentInit, OnDestroy {
  ...
  @ContentChild(InputGroupLabelDirective, /* TODO: add static flag */ { static:false}) public inputGroupLabelDirective: InputGroupLabelDirective;
  @ContentChild(InputGroupAddonLeftDirective, /* TODO: add static flag */ { static:false}) public inputGroupAddonLeftDirective: InputGroupAddonLeftDirective;
  @ContentChild(InputGroupAddonRightDirective, /* TODO: add static flag */ {static:false}) public inputGroupAddonRightDirective: InputGroupAddonRightDirective;
  @ContentChild(InputGroupContentDirective, /* TODO: add static flag */ {static:false}) public inputGroupContentDirective: InputGroupContentDirective;
  @ContentChild(InputTextDirective, /* TODO: add static flag */ {static:false}) public inputTextDirective: InputTextDirective;
