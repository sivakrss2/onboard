...
export class DropdownToggleComponent {
  ...
  @ContentChild('toggleElement', /* TODO: add static flag */ { static: false}) public toggleElement: ElementRef;
}
...
export class DropdownComponent implements AfterViewInit, OnDestroy {
  ...
  @ContentChild(DropdownToggleComponent, /* TODO: add static flag */ {static:false}) public dropdownToggleComponent: DropdownToggleComponent;
  @ContentChild(DropdownMenuComponent, /* TODO: add static flag */ {static:false}) public dropdownMenuComponent: DropdownMenuComponent;
