...
export class BoxComponent implements AfterViewInit, OnDestroy {
  ...
  @ContentChild(BoxHeaderDirective, /* TODO: add static flag */ {  static:false}) public boxHeaderDirective: BoxHeaderDirective;
  @ContentChild(BoxFooterDirective, /* TODO: add static flag */ {  static:false}) public boxFooterDirective: BoxFooterDirective;
  @ContentChild(BoxContentDirective, /* TODO: add static flag */ {  static:false}) public boxContentDirective: BoxContentDirective;
  @ContentChild(BoxToolsDirective, /* TODO: add static flag */ {  static:false}) public boxToolsDirective: BoxToolsDirective;
