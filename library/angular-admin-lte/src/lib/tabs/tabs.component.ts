...
export class TabComponent implements OnInit {
  ...
  @ContentChild(TabHeaderComponent, /* TODO: add static flag */ {static: true }) public tabHeaderComponent: TabHeaderComponent;
  @ContentChild(TabContentComponent, /* TODO: add static flag */ {static: true }) public tabContentComponent: TabContentComponent;
...
export class TabsComponent implements AfterContentInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  @Input() public navStyleClass = 'nav nav-tabs nav-justified';
  ...
  @ContentChild(TabsHeaderComponent, /* TODO: add static flag */ {static: true }) public tabsHeaderComponent: TabsHeaderComponent;
